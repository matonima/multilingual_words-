...
func _build() -> void:
	...
	disc_style.bg_color = Color("#fff6bd")
	...
	disc_style.border_color = Color("#fe005d")
	...
	center_letter.add_theme_color_override("font_color", Color("#fe005d"))
...
func _refresh() -> void:
	...
	for visible_index in range(VISIBLE_COUNT):
		...
		button.modulate = Color.WHITE if data_index == selected_index else Color("#00b1c1b8")
